...
export function useRepository() {
    ...
    if (!context) {
      ...
      const setRepositories = (results) => dispatch({ type: SET_REPOSITORY_SEARCH_RESULTS, results })
      const setActiveRepository = (repository) => dispatch({ type: SET_ACTIVE_REPOSITORY, repository })
      return {
        state,
        dispatch,
        setRepositories,
