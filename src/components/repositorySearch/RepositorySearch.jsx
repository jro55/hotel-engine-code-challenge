        ...
        <>
            ...
            />
            {
                !state.didPerformSearch && !state.repositorySearchResults.items
                    ? <DefaultText
                        handlePopularSearchTermOnClick={popularSearchTerm => handleSearch(popularSearchTerm)}
                    />
                    : <RepositoryListView
    ...
    return (
        <div className={classes.defaultTextContainer}>
            ...
            <div className={classes.defaultTextParagraph}>
                ...
                <br/>
                <a href='https://www.howtogeek.com/180167/htg-explains-what-is-github-and-what-do-geeks-use-it-for/' target={'_blank'} rel="noreferrer">
